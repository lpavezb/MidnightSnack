...
func _physics_process(delta):
	...
	dir.x = (Input.get_action_strength("move_right") - Input.get_action_strength("move_left")) # * cam_basis[0]
	dir.z  = (Input.get_action_strength("move_backwards") - Input.get_action_strength("move_forward"))  # * cam_basis[2]
	dir.y = 0
	dir = dir.normalized()
